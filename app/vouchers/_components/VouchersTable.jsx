...
export default function VouchersTable({ vouchers }) {
  ...
  const handleView = (voucherId) => {
    router.push(`/vouchers/sub/view?id=${voucherId}`)
  }

  const handleEdit = (voucherId) => {
    router.push(`/vouchers/sub/edit?id=${voucherId}`)
  }

  const handleDelete = (voucherId) => {
    router.push(`/vouchers/sub/delete?id=${voucherId}`)
  }
              ...
              >
                ...
                <TableCell sx={{ py: { xs: 1, sm: 1.5 } }}>
                  ...
                  >
                    <Button
                      size="small"
                      onClick={() => handleView(voucher.code)}
                      sx={{
                        fontSize: { xs: "0.5rem", sm: "12px" },
                        color: "#da1818",
                        textTransform: "none",
